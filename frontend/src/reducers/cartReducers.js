        ...
        case CART_ADD_ITEM:
          ...
          if(existItem) {
             return{
                 ...
                 cartItems: state.cartItems.map(x => x.product === existItem.product ? item : x) // for each x, if x.product id = existItem.product which is the id we will return itterration 
            } 
          }else {
              return {
                  ...state, 

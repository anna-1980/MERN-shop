...
export const login = (email, password) => async (dispatch) => {      //using Redux Thunk 
    try{
        dispatch({
...
export const getUserDetails = ( id) => async (dispatch, getState) => {      //using Redux Thunk 
    try{
        dispatch({
...
export const updateUserProfile = (user) => async (dispatch, getState) => {      //using Redux Thunk 
    try{
        dispatch({
...
export const deleteUser = (id) => async (dispatch, getState) => {      //using Redux Thunk 
    try{
        dispatch({
